...
@WebServlet("/SV_AltasUsuario")

	public class SV_AltasUsuario extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SV_AltasUsuario() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       if (request.getParameter("suscribirse") != null && request.getParameter("suscribirse").equals("si")) {
        ...
        Usuario u = new Usuario(email, nombre, apellidos, razonSocial, dnicif, direccionLinea1, direccionLinea2, ciudad, provincia, cp, telefono, rol, boletin, categoria, pass);
